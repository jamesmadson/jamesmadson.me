...
function updateStaticCache() {
    return caches.open(staticCacheName)
        .then( cache => {
            ...
            return cache.addAll([
                '/assets/jamesmadson-0.1.1.css',
                '/bower_components/scrollreveal/dist/scrollreveal.min.js',
                '/assets/img/hoka/hokaoneone.svg',
                '/assets/img/ampersand/ampersand.svg',
                '/assets/img/mindset/mindset.svg',
                '/assets/img/chefstable/chefstable.svg',
                '/assets/img/treadhub/treadhub.svg'
            ]);
        });
}
